...
//מקבלת את הכרטיס מהמערך שבסיטייט
export const GET_BY_ID_CARD="GET_BY_ID_CARD";
//מחיקת כרטיס
export const DELETE_CARD="DELETE_CARD";
//למנהל הבריכה -ייבוא של משתמשים לבריכה מסוימת על פי ת"ז בריכה
export const GET_USERS_BY_ID_POOL="GET_USERS_BY_ID_POOL";
