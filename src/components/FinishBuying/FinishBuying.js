...
{showDiv?
    ...
    **קבלה תשלח למייל שינתן לאחר ביצוע התשלום!**    
    </>)
...
//     <Input register={register} errors={errors} type="radio" name="payment" lablName="Paypal" on={PayPal} />
...
//     <input type="button" className="buttonn" id="keepBuying" value="המשך לקנות" onClick={keepBuying} /><br/>
//     <input type="button" value="!שלם"  className="buttonn" id="pay" onClick={()=>{setShowDiv(true);setShowCredit(false);setShowPaypal(false); document.getElementById("div").style.visibility="hidden"}}></input>
//     </div>
